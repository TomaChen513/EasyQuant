...
def main(code="600070", start_cash=1000000, stake=100, commission_fee=0.001):
    ...
    stock_hfq_df = ak.stock_zh_a_hist(symbol=code, adjust="hfq", start_date='20000101', end_date='20230617').iloc[:, :6]
...
if __name__ == '__main__':
    main(code="002373", start_cash=1000000, stake=100, commission_fee=0.001)
